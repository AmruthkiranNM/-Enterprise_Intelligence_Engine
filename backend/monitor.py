...
TRIGGER_KEYWORDS: Dict[str, List[str]] = {
    ...
    "Product": [
        "product launch", "new product", "launched", "general availability",
        "ga release", "beta launch", "new feature", "platform update",
    ],
    "Expansion": [
        "expansion", "new office", "global expansion", "entered market",
        "new region", "new geography", "international",
    ],
}
...
def _build_suggested_action(event_type: str, company_name: str) -> str:
    templates = {
        ...
        "Hiring": (
            ...
            "Position DataVex as the infrastructure that scales with the team."
        ),
        "Product": (
